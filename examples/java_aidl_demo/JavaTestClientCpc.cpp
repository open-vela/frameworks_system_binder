...
#define LOG_TAG "JavaTestClient"

#include "src/IJavaTestStuff.h"
...
extern "C" int main(int argc, char** argv)
{
    ...
    auto remoteBinder = sm->getService(String16("asvc_cpctest"));
    ...
    sp<src::IJavaTestStuff> service = interface_cast<src::IJavaTestStuff>(remoteBinder);
    if (service) {
